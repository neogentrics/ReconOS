...
**Typing** is still limited to the plain English keyboard. A character outside
that can be in a file's name and be shown, but there is no way to type one
into a text box here yet.
